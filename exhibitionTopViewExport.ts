...
.top-booth{position:relative;min-height:112px;border:1px solid rgba(255,255,255,.15);border-radius:20px;padding:8px;background:rgba(255,255,255,.055);color:#64748b;overflow:hidden;transform:perspective(800px) rotateX(7deg);transition:.2s ease}.top-booth.occupied{background:linear-gradient(145deg,var(--hall),rgba(15,23,42,.72));color:#fff;box-shadow:inset 0 1px 0 rgba(255,255,255,.25),0 18px 44px rgba(0,0,0,.25)}.top-booth.confirmed{outline:1px solid rgba(52,211,153,.36)}.top-booth.reserved{outline:1px solid rgba(251,146,60,.55)}.top-booth.occupied:hover{transform:perspective(800px) rotateX(0deg) translateY(-4px);box-shadow:0 24px 55px rgba(0,0,0,.3)}.booth-num{position:absolute;top:8px;left:8px;font-size:10px;font-weight:900;color:rgba(255,255,255,.85);font-family:ui-monospace,Menlo,monospace}.brand-roof{position:absolute;inset:24px 14px 34px;border-radius:16px;background:rgba(255,255,255,.93);display:flex;align-items:center;justify-content:center;color:#0f172a;font-weight:900;font-size:20px;box-shadow:inset 0 0 0 1px rgba(15,23,42,.08)}.brand-roof img{width:82%;height:82%;object-fit:contain}.brand-name{position:absolute;left:8px;right:8px;bottom:10px;font-size:10px;font-weight:800;line-height:1.2;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
...
@media(max-width:980px){.hero-grid{grid-template-columns:1fr}.controls-inner{grid-template-columns:1fr}.top-floor{grid-template-columns:repeat(4,minmax(70px,1fr))}.brand-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.stats{grid-template-columns:repeat(2,1fr)}.section-title{display:block}.top-floor{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding:14px}.top-booth{min-height:104px}.brand-grid{grid-template-columns:1fr}.note-head{grid-template-columns:70px 1fr auto}.note-logo{width:70px;height:70px}.hero h1{font-size:42px}}
</style>
</head>
<body>
<main>
