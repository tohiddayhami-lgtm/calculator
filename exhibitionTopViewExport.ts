...
.top-booth{position:relative;z-index:2;min-height:clamp(88px,calc(var(--booth-size,72px) * 1.45),112px);border:1px solid rgba(255,255,255,.15);border-radius:20px;padding:8px;background:rgba(255,255,255,.055);color:#64748b;overflow:hidden;transform:perspective(800px) rotateX(7deg);transition:.2s ease}.top-booth.occupied{background:linear-gradient(145deg,var(--hall),rgba(15,23,42,.72));color:#fff;box-shadow:inset 0 1px 0 rgba(255,255,255,.25),0 18px 44px rgba(0,0,0,.25)}.top-booth.confirmed{outline:1px solid rgba(52,211,153,.36)}.top-booth.reserved{outline:1px solid rgba(251,146,60,.55)}.top-booth.occupied:hover{z-index:6;transform:perspective(800px) rotateX(0deg) translateY(-4px);box-shadow:0 24px 55px rgba(0,0,0,.3)}.booth-num{position:absolute;top:8px;left:8px;font-size:10px;font-weight:900;color:rgba(255,255,255,.85);font-family:ui-monospace,Menlo,monospace}.brand-roof{position:absolute;top:26px;left:50%;width:min(64px,calc(100% - 24px));aspect-ratio:1/1;transform:translateX(-50%);border-radius:16px;background:rgba(255,255,255,.93);display:flex;align-items:center;justify-content:center;color:#0f172a;font-weight:900;font-size:20px;box-shadow:inset 0 0 0 1px rgba(15,23,42,.08);overflow:hidden}.brand-roof img{width:100%;height:100%;object-fit:cover;border-radius:inherit}.brand-name{position:absolute;left:8px;right:8px;bottom:10px;font-size:10px;font-weight:800;line-height:1.2;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
