  ...
  const hallMaps = event.categories.map(category => {
    ...
    const structureHtml = structures.map(structure => {
      const style = [
        ...
        `top:${Math.min(100, Math.max(0, structure.y))}%`,
        `width:${Math.min(100, Math.max(1, structure.width))}%`,
        `height:${Math.min(100, Math.max(1, structure.height))}%`,
    ...
    return `<section class="hall-scene" data-hall="${escapeAttr(category.id)}" style="--hall:${escapeAttr(category.color)}">
      ...
      <div class="floor-scroll"><div class="top-floor" style="--floor-cols:${cols};--booth-size:${boothSize}px;--floor-min:${floorMinWidth}px">${structureHtml}${boothCells}${markerHtml}</div></div>
...
.modal{position:fixed;inset:0;z-index:80;display:none;align-items:center;justify-content:center;padding:18px;background:rgba(2,6,23,.74);backdrop-filter:blur(14px)}.modal.open{display:flex}.note,.reserve-card{position:relative;width:min(560px,100%);border:1px solid rgba(255,255,255,.18);background:linear-gradient(180deg,rgba(15,23,42,.98),rgba(15,23,42,.9));border-radius:34px;padding:22px;box-shadow:0 35px 120px rgba(0,0,0,.45);overflow:hidden}.note:before,.reserve-card:before{content:"";position:absolute;inset:-35% auto auto -18%;width:260px;height:260px;background:var(--noteHall,#22d3ee);opacity:.22;filter:blur(80px)}.note-head{position:relative;display:grid;grid-template-columns:86px 1fr auto;gap:14px;align-items:center}.note-logo{width:86px;height:86px;border-radius:24px;background:#fff;color:#0f172a;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:24px;overflow:hidden}.note-logo img{width:100%;height:100%;object-fit:cover;border-radius:inherit}.note h3,.reserve-card h3{margin:0;font-size:27px;line-height:1.15}.note .note-sub,.reserve-card .note-sub{margin:6px 0 0;color:#c4b5fd;font-size:13px;font-weight:800}.close{border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.08);color:#fff;border-radius:14px;width:38px;height:38px}.note-body{position:relative;margin-top:18px}.note-body p{color:#dbeafe;line-height:1.75}.chips{display:flex;flex-wrap:wrap;gap:8px;margin:14px 0}.chips span{border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.06);border-radius:999px;padding:7px 10px;color:#cbd5e1;font-size:12px}.enter-store{display:flex;justify-content:center;text-decoration:none;border-radius:18px;background:linear-gradient(135deg,var(--noteHall,#22d3ee),#8b5cf6);padding:14px 16px;font-weight:900;margin-top:18px}.disabled-store{display:block;text-align:center;border-radius:18px;background:rgba(255,255,255,.07);color:#94a3b8;padding:14px 16px;font-weight:800;margin-top:18px}.reserve-head{position:relative;display:flex;align-items:flex-start;justify-content:space-between;gap:14px}.reserve-form{position:relative;margin-top:16px;display:grid;gap:10px}.reserve-form label{display:grid;gap:5px;color:#cbd5e1;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.08em}.reserve-form input,.reserve-form textarea{width:100%;border:1px solid rgba(255,255,255,.16);background:rgba(2,6,23,.48);color:#fff;border-radius:14px;padding:11px 12px;outline:none}.reserve-form textarea{min-height:76px;resize:vertical}.reserve-form input:focus,.reserve-form textarea:focus{border-color:#22d3ee;box-shadow:0 0 0 4px rgba(34,211,238,.1)}.reserve-actions{display:flex;gap:10px;margin-top:4px}.reserve-submit{flex:1;border:0;border-radius:16px;background:linear-gradient(135deg,#f97316,#22d3ee);color:#fff;padding:13px 14px;font-weight:900}.reserve-submit:disabled{opacity:.55;cursor:not-allowed}.reserve-status{color:#bfdbfe;font-size:12px;line-height:1.6;min-height:20px}.footer{padding:28px 18px 46px;text-align:center;color:#64748b;font-size:12px}
