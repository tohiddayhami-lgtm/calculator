...
@media(max-width:980px){.hero-grid{grid-template-columns:1fr}.controls-inner{grid-template-columns:1fr}.brand-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){body{overflow-x:hidden}.hero{padding:24px 12px 22px}.badge{font-size:10px;padding:7px 10px}.hero-grid{gap:16px;margin-top:18px}.hero h1{font-size:clamp(30px,10vw,42px);line-height:1.04;letter-spacing:-.045em}.hero .lead{font-size:14px;line-height:1.55;margin-top:12px}.meta{gap:7px;margin-top:14px}.meta span{font-size:11px;border-radius:12px;padding:8px 10px}.stats-panel{border-radius:24px;padding:12px}.stats{grid-template-columns:repeat(2,1fr);gap:8px}.stat{border-radius:18px;padding:12px}.stat b{font-size:27px}.stat span{font-size:10px;letter-spacing:.04em}.controls-inner{padding:10px 12px}.search{border-radius:14px;padding:10px 12px;font-size:13px}.hall-filter{font-size:12px;padding:8px 11px}.section{padding:18px 10px;overflow:hidden}.section-title{display:block;margin-bottom:12px}.section-title h2{font-size:22px}.section-title p{font-size:12px;line-height:1.55}.legend{gap:6px;margin-top:10px}.legend span{font-size:10px;padding:6px 8px}.hall-scene{border-radius:24px;padding:12px 10px 16px;margin-bottom:16px}.hall-title{gap:10px;padding-bottom:10px}.hall-title h2{font-size:19px}.hall-title span{font-size:11px}.hall-title strong{font-size:23px}.aisle-label{font-size:9px;margin-bottom:7px}.aisle-label.bottom{margin-top:8px}.floor-scroll{overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;padding:0 2px 8px;scrollbar-width:thin}.top-floor{gap:8px;padding:12px;border-radius:20px;grid-template-columns:repeat(var(--floor-cols,8),minmax(48px,1fr));min-width:max(640px,100%)}.top-booth{min-height:70px;border-radius:14px;transform:none;padding:6px}.top-booth.occupied:hover,.top-booth.empty:hover{transform:translateY(-2px)}.booth-num{top:6px;left:6px;font-size:8px}.reserve-hint{bottom:7px;font-size:8px;letter-spacing:.06em}.brand-roof{top:20px;width:min(34px,calc(100% - 22px));border-radius:10px}.brand-name{left:4px;right:4px;bottom:5px;font-size:8.5px;border-radius:8px;padding:2px 3px}.top-booth.public-pending .brand-name{bottom:19px}.map-marker{min-width:84px;max-width:126px;gap:5px;border-radius:13px;padding:6px 7px;box-shadow:0 10px 24px rgba(0,0,0,.24),0 0 0 4px rgba(255,255,255,.03)}.map-marker .marker-icon{min-width:28px;height:22px;border-radius:8px;font-size:8px}.map-marker b{font-size:10px}.map-marker small{font-size:8px}.map-marker:after{width:11px;height:11px;bottom:-7px}.map-marker.ad{min-width:112px}.map-structure b{font-size:9px}.map-structure small{font-size:7px}.brand-grid{grid-template-columns:1fr;gap:10px}.brand-card{grid-template-columns:58px 1fr;border-radius:20px;padding:12px}.brand-logo{width:58px;height:58px;border-radius:16px}.brand-copy h3{font-size:17px}.brand-copy p{font-size:12px}.note-btn{border-radius:13px;padding:9px 11px}.modal{align-items:flex-end;padding:10px}.reserve-card{max-height:88vh;border-radius:24px 24px 18px 18px;padding:16px}.reserve-head{top:-16px;margin:-16px -16px 0;padding:14px 16px 10px}.reserve-form{grid-template-columns:1fr}.reserve-form input,.reserve-form textarea{font-size:12px;padding:8px 10px}.reserve-form textarea{min-height:52px}.reserve-card h3{font-size:19px}.note-head{grid-template-columns:58px 1fr auto;gap:10px}.note-logo{width:58px;height:58px;border-radius:16px}.note h3{font-size:21px}}
</style>
</head>
<body>
<main>
