...
export interface CatalogConfig {
  ...
  storySubtitleBold?: boolean;
  storyCtaTitleBold?: boolean;
  storyCtaTextBold?: boolean;
  storyExtraTextBold?: boolean;
  storyCtaBgColor?: string;
  storyCtaBgOpacityPct?: number;
  storyShowExtraText?: boolean;
  storyExtraText?: string;
  storyExtraTextAlign?: 'left' | 'center' | 'right';
  storyExtraTextOffsetPct?: number;
  storyExtraTextFontSizePx?: number;
  storyExtraTextColor?: string;
  storyExtraBoxColor?: string;
...
export interface ExhibitionReservation {
  ...
  city: string;
  products: string;
  /** Company logo URL or data URL, shown on the generated top-view exhibition hall */
  logoUrl?: string;
